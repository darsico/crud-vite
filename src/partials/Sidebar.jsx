        ...
        <div className="space-y-8">
          ...
          <div>
            ...
            <ul className="mt-2">
              ...
              <li className={`px-3 py-2 rounded-sm mb-0.5 last:mb-0 ${pathname.includes("analytics") && "bg-slate-900"}`}>
                <NavLink end to="/analytics" className={`block text-slate-200 hover:text-white truncate transition duration-150 ${pathname.includes("analytics") && "hover:text-slate-200"}`}>
                  <div className="flex items-center">
                    ...
                    <span className="ml-3 text-sm font-medium duration-200 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100">Análisis</span>
                  </div>
                </NavLink>
              </li>
              ...
              <SideBarItem icon={<FiSettings className={`w-6 h-6 shrink-0 ${pathname.includes("configuration") && "text-indigo-600"}`} />} pathnameRoute="configuration" itemName="Configuración" />
            </ul>
            ...
            <ul className="mb-2">
              ...
              <SideBarItem icon={<BsFillTagsFill className={`w-6 h-6 shrink-0 ${pathname.includes("categories") && "text-indigo-600"}`} />} itemName="Categorías" pathnameRoute="categories" />
