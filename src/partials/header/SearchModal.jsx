        ...
        <div ref={modalContent} className="bg-white overflow-auto max-w-2xl w-full max-h-full rounded shadow-lg">
          ...
          <form className="border-b border-slate-200">
            <div className="relative">
              ...
              <input
                ...
                ref={searchInput}
              />
              <button className="absolute inset-0 right-auto group" type="submit" aria-label="Busca lo que quieras">
                <svg
          ...
          <div className="py-4 px-2">
            ...
            <div className="mb-3 last:mb-0">
              <div className="text-xs font-semibold text-slate-400 uppercase px-2 mb-2">Ultimas búsquedas</div>
